...
import { addDebouncer, flush } from '../@polymer/polymer/lib/legacy/polymer.dom.js';
    ...
    */
    ...
    updateViewportBoundaries: function() {
      this._scrollerPaddingTop = this.scrollTarget === this ? 0 :
          parseInt(window.getComputedStyle(this)['padding-top'] || 0, 10);
    ...
    _increasePoolIfNeeded: function() {
      ...
      if (currentPage === 0) {
        ...
        addDebouncer(this.debounce('_debounceTemplate', this._increasePool.bind(this, this._itemsPerRow), 16));
      } else {
    ...
    _debounceTemplate: function(fn) {
      addDebouncer(this.debounce('_debounceTemplate', fn));
    },
    ...
    _resizeHandler: function() {
      ...
      addDebouncer(this.debounce('_debounceTemplate', function() {
        this.updateViewportBoundaries();
        this._render();
