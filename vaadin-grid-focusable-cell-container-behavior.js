...
vaadin.elements.grid.FocusableCellContainerBehavior = {
  ...
  _announceFocusedCell: function(cell, focused) {
    ...
    var activeTarget = Element ? cell._cellContent.getAttribute('slot') : cell._cellContent.id;
    ...
    if (this.is === 'vaadin-grid-table-body' && !cell.hasAttribute('detailscell')) {
      ...
      var index = Array.prototype.indexOf.call(dom(cell.parentElement).querySelectorAll('.vaadin-grid-cell'), cell);
  ...
  _focusedCellChanged: function(rowIndex, cellIndex) {
    ...
    Array.prototype.forEach.call(dom(this).children, function(row, i) {
