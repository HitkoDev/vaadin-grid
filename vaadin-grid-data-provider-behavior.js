...
$_documentContainer.innerHTML = `<dom-module id="vaadin-grid-data-provider-themability-styles">
  <template>
    <style>
...
vaadin.elements.grid.DataProviderBehavior = {
  ...
  _templateItemChanged: function(e) {
    ...
    Array.prototype.forEach.call(dom(this.$.items).children, function(row) {
      if (row.item === item) {
